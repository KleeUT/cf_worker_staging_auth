...
describe('Auth0 Helper', () => {
  it('should generate a login url', () => {
    ...
    expect(loginUrl).toEqual(
      'https://staging-saladsimulator.au.auth0.com/authorize?response_type=code&client_id=auth0ClientID&redirect_uri=https%3A%2F%2Fstage.saladsimulator.com%2Fauth%2Fcallback&audience=saladsimulator-staging&code_challenge=AChallengeString&code=S256',
    );
  });
});
